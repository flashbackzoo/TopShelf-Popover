...
try{i[a.settings.transition].tranOut(a)}catch(c){}}},c={mask:function(a,b){a&&b()},drag:function(a,b,c){i.drag(a.container,b,c)},openCallback:function(a){void 0!==a.settings.callbacks.open&&a.settings.callbacks.open(a)},closeCallback:function(a){c.resetPopover(a);void 0!==a.settings.callbacks.close&&a.settings.callbacks.close(a)},resetPopover:function(a){b(a.container).css({top:"",left:"","margin-left":"","margin-top":""})},getPopoverObjectById:function(a){var c={};b(f).each(function(g,e){currentContainerId=
